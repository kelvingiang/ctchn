<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="page-list" id="articles-business-list">
        <?php 
            //$cateName = '商情資訊';
            $itemCount = 1;
            $wp_query = new WP_Query(getPostType('post',5,3));
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        var alreadyScroll = true; //biến dùng kiểm tra xem page đã scroll chưa
            ...
            if(jQuery(window).scrollTop() > (docHeight - winHeight) && alreadyScroll == true){
                ...
                jQuery.ajax({
                    ...
                    success: function(res) {
                        jQuery('#articles-business-list').append(res);
                        page++;
