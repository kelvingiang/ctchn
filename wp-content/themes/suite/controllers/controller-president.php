...
class Admin_Controller_President{
    public function __construct()
    {
        ...
        add_action('manage_edit-president_columns', array($this, 'manage_columns'));
        add_action('manage_president_posts_custom_column', array($this, 'render_columns'));

        add_filter('manage_edit-president_sortable_columns', array($this, 'sortable_views_column'));
